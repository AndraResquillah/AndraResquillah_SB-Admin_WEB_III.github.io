        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="<?php echo base_url('admin/dataBiodata')?>">Biodataku</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseUtilities"
                    ...
                    <i class="fas fa_fw fa-money-check-alt"></i>
                    <span>Transaksi</span>
                </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded"> 
                        <a class="collapse-item" href="<?php echo base_url ('admin/LaporanGaji') ?>">Lapora Gaji</a>
                        <a class="collapse-item" href="<?php echo base_url ('admin/LaporanAbsensi') ?>">Lapora Absensi</a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <table> 
                        <tr>
                            <th>APLIKASI PENGGAJIAN_11194075</th> </tr>
                        <tr>
                            <th>
                                <h5 class="font-weight-bold">PT. KANTOR PUSAT</h5>
                            </th> </tr>
                    </table>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small">SELAMAT DATANG ANDRA_075</span>
                                <img class="img-profile rounded-circle" 
                                    src="https://tse2.mm.bing.net/th?id=OIP.QI9R3cKsCU8FijDwaenjagHaHk&pid=Api&P=0&w=185&h=189" alt="LOGO">
                            </a>
